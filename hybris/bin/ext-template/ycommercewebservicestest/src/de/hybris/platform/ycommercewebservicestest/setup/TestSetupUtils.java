...
public class TestSetupUtils
{
	...
	{
		final YCommerceWebServicesTestSetup setup = Registry.getApplicationContext().getBean(YCommerceWebServicesTestSetup.class,
		...
		final SystemSetupContext context = new SystemSetupContext(params, Type.ALL, Process.ALL, "ycommercewebservicestest");

...
describe('abAnalyticsDecoratorController', function() {
    ...
    beforeEach(function() {
        fixture = AngularUnitTestHelper.prepareModule('abAnalyticsDecoratorControllerModule')
            .mock('abAnalyticsService', 'getABAnalyticsForComponent').andReturnResolvedPromise({
                aValue: 30,
                bValue: 70
            })
    ...
    it('should bind an inner content template to the controller scope', function() {
        ...
        // Assert
        expect(controller.contentTemplate).toBe('web/features/ysmarteditmodule/abAnalyticsDecorator/abAnalyticsDecoratorContentTemplate.html');
    });

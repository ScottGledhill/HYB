...
module.exports = function(config) {
    config.set({
        ...
        files: [
            ...
            'bower_components/angular-bootstrap/ui-bootstrap-tpls.js', //needed since contains $modal

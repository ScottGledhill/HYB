...
public class AtpFormulaIntegrationTest extends BaseAcceleratorSourcingIntegrationTest
{
	...
	{
		updateFormula(atpFormulas.customFormula(null, null, null, null, null, null, null, null, null));
	...
	{
		updateFormula(atpFormulas.customFormula(true, null, null, null, null, null, null, null, null));
	...
	{
		updateFormula(atpFormulas.customFormula(true, false, null, null, null, null, null, null, null));
	...
	{
		updateFormula(atpFormulas.customFormula(true, false, true, null, null, null, null, null, null));
	...
	{
		updateFormula(atpFormulas.customFormula(true, false, true, null, null, false, null, null, null));
	...
	{
		updateFormula(atpFormulas.customFormula(true, false, true, null, null, false, false, null, null));
	...
	{
		updateFormula(atpFormulas.customFormula(true, false, true, true, null, false, false, null, null));
		checkGlobalAndLocalAtp(Long.valueOf(MONTREAL_STOCK_QTY - getAllocatedQuantity() + getCancelQuantity() - SHRINKED_QTY - WASTED_QTY + INCREASED_QTY));
	}
	...
	{
		updateFormula(atpFormulas.customFormula(null, null, null, null, null, false, false, null, null));
	...
	public void getAtp_WithReturnedBinCode_WithoutReturned()
	{
		...
		stockLevels.NewStockLevel(products.Camera(),warehouses.Montreal(),500);
		updateFormula(atpFormulas.customFormula(true, null, null, null, null, null, null, null, null));
		assertEquals( (Long.valueOf(500)), commerceStockService.getStockLevelForProductAndPointOfService(products.Camera(), pointsOfService.Montreal_Downtown()));
		assertEquals( (Long.valueOf(BOSTON_STOCK_QTY + 500)), commerceStockService.getStockLevelForProductAndBaseStore(products.Camera(), baseStores.NorthAmerica()));
	}
	...
	public void getAtp_WithReturned()
	{
		...
		modelService.save(stockLevel);
		stockLevels.NewStockLevel(products.Camera(),warehouses.Montreal(),500);
		updateFormula(atpFormulas.customFormula(null, null, null, null, null, null, null, true, null));
		assertEquals( (Long.valueOf(MONTREAL_STOCK_QTY)), commerceStockService.getStockLevelForProductAndPointOfService(products.Camera(), pointsOfService.Montreal_Downtown()));
		assertEquals( (Long.valueOf(MONTREAL_STOCK_QTY)), commerceStockService.getStockLevelForProductAndBaseStore(products.Camera(), baseStores.NorthAmerica()));
	}
	...
	public void getAtp_WithExternal()
	{
		...
		final StockLevelModel externalStockLevelMontreal = stockLevels.Camera(externalWarehouseMontreal, MONTREAL_EXTERNAL_STOCK_QTY);
		modelService.save(externalStockLevelMontreal);
		//setup formula with only external
		updateFormula(atpFormulas.customFormula(null, null, null, null, null, null, null, null, true));
		//check local and global atp
		assertEquals( (Long.valueOf(MONTREAL_EXTERNAL_STOCK_QTY)), commerceStockService.getStockLevelForProductAndPointOfService(products.Camera(), pointsOfService.Montreal_External()));
		assertEquals( (Long.valueOf(MONTREAL_EXTERNAL_STOCK_QTY)), commerceStockService.getStockLevelForProductAndBaseStore(products.Camera(), baseStores.NorthAmerica()));
	}

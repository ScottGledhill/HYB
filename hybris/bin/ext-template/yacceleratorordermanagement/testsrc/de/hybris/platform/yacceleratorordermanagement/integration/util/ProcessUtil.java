...
public class ProcessUtil extends BaseUtil
{
	...
	public void waitUntilReturnProcessExist(final ReturnRequestModel returnRequest, final String processName, final int timeOut) throws InterruptedException
	{
		int timeCount = 0;
		long returnProcess;
		do
			...
			throws InterruptedException
	{
		...
		while (returnRequestModel.getReturnProcess().stream().allMatch(p -> ProcessState.RUNNING.equals(p.getProcessState())) && timeCount++ < timeOut);
	}

...
public class SapproductconfigrulesbackofficeManager extends GeneratedSapproductconfigrulesbackofficeManager
{
	...
	private static final Logger LOG = Logger.getLogger(SapproductconfigrulesbackofficeManager.class.getName());
	 ...
	 */
	public static SapproductconfigrulesbackofficeManager getInstance()
	{
		return (SapproductconfigrulesbackofficeManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductconfigrulesbackofficeConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public SapproductconfigrulesbackofficeManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of SapproductconfigrulesbackofficeManager called.");
		}
	}

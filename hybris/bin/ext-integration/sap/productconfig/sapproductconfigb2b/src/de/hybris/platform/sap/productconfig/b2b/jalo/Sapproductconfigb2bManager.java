...
public class Sapproductconfigb2bManager extends GeneratedSapproductconfigb2bManager
{
	...
	{
		return (Sapproductconfigb2bManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Sapproductconfigb2bConstants.EXTENSIONNAME);
	}

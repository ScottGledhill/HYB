...
public class SapproductconfigmodelManager extends GeneratedSapproductconfigmodelManager
{
	...
	{
		return (SapproductconfigmodelManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductconfigmodelConstants.EXTENSIONNAME);
	}

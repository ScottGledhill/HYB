...
/**
 * This is the extension manager of the Sapproductconfigrules extension.
 */
public class SapproductconfigrulesManager extends GeneratedSapproductconfigrulesManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = LoggerFactory.getLogger(SapproductconfigrulesManager.class);
	 ...
	 */
	public SapproductconfigrulesManager() // NOPMD
	{
		LOG.debug("constructor of SapproductconfigrulesManager called.");
	}
	 ...
	 */
	public static SapproductconfigrulesManager getInstance()
	{
		return (SapproductconfigrulesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(SapproductconfigrulesConstants.EXTENSIONNAME);
	}
	...
	public void init()
	{
		LOG.debug("init() of SapproductconfigrulesManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapproductconfigrulesManager called, current tenant: {}", getTenant().getTenantID());
	}

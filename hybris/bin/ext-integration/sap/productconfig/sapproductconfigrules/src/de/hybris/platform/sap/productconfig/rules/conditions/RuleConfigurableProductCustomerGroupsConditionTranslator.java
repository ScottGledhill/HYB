...
public class RuleConfigurableProductCustomerGroupsConditionTranslator implements RuleConditionTranslator
{
			...
			final RuleConditionDefinitionData conditionDefinition) throws RuleCompilerException
	{
		...
		RuleIrGroupCondition irCustomerGroupsResultCondition = null;
	...
	protected ProductConfigRuleContainedDeepOperator retrieveCustomerGroupsOperator(final RuleConditionData condition)
	{
		...
		{
			customerGroupsOperator = (ProductConfigRuleContainedDeepOperator) customerGroupsOperatorParameter.getValue();
		}
	...
	protected List<String> retrieveCustomerGroups(final RuleConditionData condition)
	{
		...
		{
			customerGroups = (List<String>) customerGroupsParameter.getValue();
		}
		return customerGroups;
	}

	protected RuleIrGroupCondition prepareCustomerInAnyGroupConditions(final RuleCompilerContext context,

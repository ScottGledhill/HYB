...
public class ConfigurationRulesTestData
{
			...
			final List<CsticGroupModel> csticGroups)
	{
		...
		rootInstance.addCstic(createRadioButtonCstic("CSTIC_1.2", CsticValueModel.AUTHOR_USER,
				CsticValueModel.AUTHOR_EXTERNAL_USER, true));
		rootInstance.addCstic(createRadioButtonCstic("CSTIC_1.3", CsticValueModel.AUTHOR_USER,
				CsticValueModel.AUTHOR_EXTERNAL_USER, false));
		rootInstance.addCstic(createCheckBoxListCstic("CSTIC_1.4", CsticValueModel.AUTHOR_USER,
				CsticValueModel.AUTHOR_EXTERNAL_USER, true));
	...
	protected static void createGroup2WithCsticAndAssignedValues(final InstanceModel rootInstance,
			final List<CsticGroupModel> csticGroups)
	{
		rootInstance.addCstic(createCheckBoxListCstic("CSTIC_2.1", CsticValueModel.AUTHOR_USER,
				CsticValueModel.AUTHOR_EXTERNAL_USER, true));
		rootInstance.addCstic(createCheckBoxListCstic("CSTIC_2.2", null, null, true));
		rootInstance.addCstic(createRadioButtonCstic("CSTIC_2.3", CsticValueModel.AUTHOR_USER,
				CsticValueModel.AUTHOR_EXTERNAL_USER, true));
			...
			RuleEngineService ruleEngineService, I18NService i18nService, RuleParametersService ruleParamService)
	{
		...
		classUnderTest.setRuleActionChecker(new ProductConfigRuleActionStrategyCheckerImpl());
		...
		if (ruleEngineService == null)
		{
			...
			given(ruleEngineService.getRuleForCode(any(String.class))).willReturn(ruleModel);

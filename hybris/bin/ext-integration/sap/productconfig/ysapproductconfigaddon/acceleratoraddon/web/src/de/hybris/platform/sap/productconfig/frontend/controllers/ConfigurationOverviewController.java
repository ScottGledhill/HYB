...
public class ConfigurationOverviewController extends AbstractProductConfigController
{
	 ...
	 */
	@RequestMapping(value = "/**/{productCode:.*}" + SapproductconfigfrontendWebConstants.CONFIG_OVERVIEW_URL, method = RequestMethod.GET)
	 ...
	 * @throws CMSItemNotFoundException
	 */
	@RequestMapping(value = "/**/{productCode:.*}" + SapproductconfigfrontendWebConstants.CONFIG_OVERVIEW_URL, method = RequestMethod.POST)
	@ResponseBody
			...
			throws CMSItemNotFoundException
	{
		...
		overviewUIData.setConfigurationOverviewData(populateConfigurationModel(uiStatus,
	...
	{
		return getConfigurationOverviewFacade().getOverviewForConfiguration(uiStatus.getConfigId(), updatedOverview);
	}
			...
			final UiStatus uiStatus, final ConfigurationOverviewData overview) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(WebConstants.BREADCRUMBS_KEY, productConfigurationBreadcrumbBuilder.getOverviewBreadcrumbs(productCode));
		...
		final OverviewUiData overviewUIData = prepareOverviewUiData(uiStatus, overview, configId, kbKey);
	...
	protected OverviewUiData prepareOverviewUiData(final UiStatus uiStatus, final ConfigurationOverviewData overview,
			final String configId, final KBKeyData kbKey)
	{
		final OverviewUiData overviewUIData = new OverviewUiData();
		overviewUIData.setConfigId(configId);

		final Integer cartEntryNumber = getCartEntryNumber(kbKey);
		overviewUIData.setCartEntryNumber(cartEntryNumber);

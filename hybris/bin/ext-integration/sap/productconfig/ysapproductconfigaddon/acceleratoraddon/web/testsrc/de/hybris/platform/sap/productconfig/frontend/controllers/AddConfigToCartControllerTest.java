...
public class AddConfigToCartControllerTest extends AbstractProductConfigControllerTest
{
	...
	public void testAddConfigToCartIsCorrect() throws Exception
	{
		...
		classUnderTest.addConfigToCart(kbKey.getProductCode(), configData, bindingResults, model, redirectAttributes);
	...
	public void testCopy() throws Exception
	{
		...
		uiStatus.setConfigId(CONFIG_ID);
		given(sessionAccessFacade.getUiStatusForProduct(kbKey.getProductCode())).willReturn(uiStatus);
		given(configCartIntegrationFacade.copyConfiguration(CONFIG_ID, kbKey.getProductCode())).willReturn(CONFIG_ID);

		final String targetUrl = classUnderTest.copyConfiguration(kbKey.getProductCode(), "/");

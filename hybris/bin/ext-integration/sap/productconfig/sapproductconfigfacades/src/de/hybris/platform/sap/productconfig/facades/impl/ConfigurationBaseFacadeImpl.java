...
public class ConfigurationBaseFacadeImpl
{
	...
	{
		final List<ProductConfigMessageData> uiMessages = new ArrayList(configModel.getMessages().size());
		for (final ProductConfigMessage message : configModel.getMessages())
		{
			final ProductConfigMessageData uiMessage = new ProductConfigMessageData();
			uiMessage.setMessage(message.getMessage());

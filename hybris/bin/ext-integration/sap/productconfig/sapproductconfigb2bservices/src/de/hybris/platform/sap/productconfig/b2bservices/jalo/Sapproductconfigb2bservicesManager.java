...
public class Sapproductconfigb2bservicesManager extends GeneratedSapproductconfigb2bservicesManager
{
	...
	{
		return (Sapproductconfigb2bservicesManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(Sapproductconfigb2bservicesConstants.EXTENSIONNAME);
	}

 ...
 */
public class ImpressionCallback extends MyCallback
{
	private static final Logger LOG = LoggerFactory.getLogger(ImpressionCallback.class);

	/**
	 * InteractionCallback constructor
	 */
	public ImpressionCallback()
	{
		super();
	}
	...
	public WriteFeedCallbackResult retrieveFeedResult(final WriteFeedCallbackContext context) throws ODataApplicationException
	{
		...
		try
		{
			if (isNavigationFromTo(context, SapproductrecommendationConstants.IMPRESSION,
					SapproductrecommendationConstants.IMPRESSION_COUNT))
			{

 ...
 */
package de.hybris.platform.sapprodrecobuffer.jalo;
...
public class SapprodrecobufferManager extends GeneratedSapprodrecobufferManager
{
	...
	public void init()
	{
		LOG.debug("init() of SapprodrecobufferManager called, current tenant: {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOG.debug("destroy() of SapprodrecobufferManager called, current tenant: {}", getTenant().getTenantID());
	}

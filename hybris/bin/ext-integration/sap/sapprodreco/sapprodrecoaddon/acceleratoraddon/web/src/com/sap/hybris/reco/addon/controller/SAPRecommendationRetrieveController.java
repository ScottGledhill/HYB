...
public class SAPRecommendationRetrieveController
{
			...
			final Model model) throws UnsupportedEncodingException
	{
		...
		String userId = productRecommendationManagerFacade.getSessionUserId();
		String cookieId = CookieHelper.getPiwikID(request);
		...
		productRecommendationManagerFacade.populateContext(context, (CMSSAPRecommendationComponentModel) component, productCode, userId, cookieId);
	
		if (StringUtils.isEmpty(cmssapRecommendationComponentModel.getRecotype()))
		{
		...
		model.addAttribute("recoType", cmssapRecommendationComponentModel.getRecotype());
		model.addAttribute("leadingitemdstype", cmssapRecommendationComponentModel.getLeadingitemdstype());
		model.addAttribute("cartitemdstype", cmssapRecommendationComponentModel.getCartitemdstype());
			...
			throws UnsupportedEncodingException
	{
			...
			if (productRecommendationManagerFacade.isSessionUserAnonymous())
			{

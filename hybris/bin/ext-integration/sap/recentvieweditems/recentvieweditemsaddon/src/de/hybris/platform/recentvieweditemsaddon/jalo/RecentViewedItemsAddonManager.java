...
public class RecentViewedItemsAddonManager extends GeneratedRecentViewedItemsAddonManager
{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(RecentViewedItemsAddonManager.class);
	...
	{
		LOGGER.debug("constructor of RecentvieweditemsaddonManager called.");
	...
	public void init()
	{
		LOGGER.debug("init() of RecentvieweditemsaddonManager called. {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOGGER.debug("destroy() of RecentvieweditemsaddonManager called, current tenant: {}", getTenant().getTenantID());
	}

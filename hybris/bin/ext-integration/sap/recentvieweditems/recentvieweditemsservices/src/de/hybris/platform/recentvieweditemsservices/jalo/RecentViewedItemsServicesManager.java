...
public class RecentViewedItemsServicesManager extends GeneratedRecentViewedItemsServicesManager
{
	...
	private static final Logger LOGGER = LoggerFactory.getLogger(RecentViewedItemsServicesManager.class);
	...
	{
		LOGGER.debug("constructor of RecentViewedItemsServicesManager called.");
	}
	...
	public void init()
	{
		LOGGER.debug("init() of RecentViewedItemsServicesManager called. {}", getTenant().getTenantID());
	}
	...
	public void destroy()
	{
		LOGGER.debug("destroy() of RecentViewedItemsServicesManager called, current tenant: {}", getTenant().getTenantID());
	}

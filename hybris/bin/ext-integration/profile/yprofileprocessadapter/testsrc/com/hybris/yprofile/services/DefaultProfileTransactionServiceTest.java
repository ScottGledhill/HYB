...
public class DefaultProfileTransactionServiceTest {
    ...
    public void verifyOrderWithValidConsentReferenceIsSentToYProfile(){
        ...
        when(client.sendOrderEvent(anyString(), anyObject())).thenReturn(Observable.just(response));
        ...
        verify(client, times(1)).sendOrderEvent(anyString(), anyObject());
    ...
    public void verifyDoNotTransactionToYaasWithInvalidYaaSConfiguration(){
        ...
        verify(client, times(0)).sendOrderEvent(anyString(), anyObject());
    }

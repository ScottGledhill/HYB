...
public class CustomerInterestsDataProvider implements FragmentModelProvider<List<ProductInterestsOfCustomer>>
{
	private static final String BY_NAME_ASC = "byNameAsc";
	private ProductInterestFacade productInterestFacade;

	@Override
	public List<ProductInterestsOfCustomer> getModel(final Map<String, String> parameters)
	{
		...
		final List<ProductInterestsOfCustomer> productsByCustomerInterests = getProductInterestFacade()
				.getProductsByCustomerInterests(createPageableData(limit));
		return productsByCustomerInterests;
	}

 ...
 */
.controller("YTreeController", function($scope, $q, TreeService, _TreeDndOptions, lodash) {

        this.treeOptions = new _TreeDndOptions(this.dragOptions);

        var treeService = new TreeService(this.nodeUri);
        ...
        this.toggleAndfetch = function(handle) {
            ...
            var nodeData = handle.$modelValue;
            if (handle.collapsed) {
                return this.fetchData(nodeData).then(function(nodes) {
                    handle.toggle();
        ...
        this.newChild = function(handle) {
            ...
            treeService.saveNode(nodeData).then(function(response) {
        ...
        this.newSibling = function(handle) {
            ...
            treeService.saveNode(parent).then(function(response) {
        ...
        this.remove = function(handle) {
            ...
            var nodeData = handle.$modelValue;
            treeService.removeNode(nodeData).then(function() {
                var parent = nodeData.parent;
        ...
        Object.keys(this.nodeActions).forEach(function(functionName) {
            this[functionName] = this.nodeActions[functionName].bind(this, treeService);
            this.nodeActions[functionName] = this.nodeActions[functionName].bind(this, treeService);
        }.bind(this));
    ...
    .factory('_TreeDndOptions', function(treeConfig, $translate, treeConfig, confirmationModalService, lodash, $q, alertService) {
    ...
    .directive('ytree', function() {
        ...
        return {
            ...
            transclude: false,
            replace: false,
            templateUrl: 'web/common/services/tree/treeTemplate.html',

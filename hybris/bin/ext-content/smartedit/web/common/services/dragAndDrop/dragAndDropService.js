...
(function() {
     ...
     *
     */
    angular.module('dragAndDropServiceModule', ['yLoDashModule', 'browserServiceModule', '_dragAndDropScrollingModule'])
     ...
     * experience.
     */
    .service('dragAndDropService', function($timeout, lodash, browserService, _dragAndDropScrollingService, SUPPORTED_BROWSERS) {
        // Constants
         ...
         * @param {String} configuration.sourceSelector This parameter specifies the jQuery selector used to locate the draggable elements managed by the current instance of the drag and drop service.
         * @param {String} configuration.targetSelector This parameter specifies the jQuery selector used to locate the droppable elements where draggable items of this instance can be dropped.
        ...
        // Draggable Listeners
        this._onDragStart = function(configuration, jQueryEvent) {
            ...
            $timeout(function() {
                ...
                this._setDragImage(configuration, evt);
        ...
        this._onDragEnd = function(configuration, jQueryEvent) {
            var evt = jQueryEvent.originalEvent;
        ...
        // Droppable Listeners
        this._onDragEnter = function(configuration, jQueryEvent) {
            var evt = jQueryEvent.originalEvent;
            evt.preventDefault();
        ...
        this._onDragOver = function(configuration, jQueryEvent) {
            var evt = jQueryEvent.originalEvent;
            evt.preventDefault();
        ...
        this._onDrop = function(configuration, jQueryEvent) {
            var evt = jQueryEvent.originalEvent;
            evt.preventDefault(); // Necessary to receive the on drop event. Otherwise, other handlers are executed.
            evt.stopPropagation();

            if (evt.relatedTarget && evt.relatedTarget.nodeType == 3) return;
        ...
        this._onDragLeave = function(configuration, jQueryEvent) {
            var evt = jQueryEvent.originalEvent;
            evt.preventDefault();
        ...
        // Helper Functions
        this._setDragImage = function(configuration, evt) {
            if (configuration.helper && evt.dataTransfer.setDragImage) {
                evt.dataTransfer.setDragImage(configuration.helper(), 0, 0);
            }
        };

 ...
 */
angular.module("sliderPanelServiceModule", [])

.factory("sliderPanelServiceFactory", function() {
    ...
    function sliderPanelService(element, window, configuration) {
        ...
        this.sliderPanelConfiguration = _.defaultsDeep(
            configuration,
        ...
        var parent = angular.element(
            (this.sliderPanelConfiguration.cssSelector) ?
    ...
    return {
         ...
         * @param {Boolean} configuration.greyedOutOverlay Indicates if the slider panel overlay turns from transparent to opaque dark grey or not.

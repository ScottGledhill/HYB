...
.controller('yActionableSearchItemController', function($scope, systemEventService) {
    ...
    var defaultActionText = 'yationablesearchitem.action.create';
 ...
 * @param {@String=} [actionText='yationablesearchitem.action.create'] The i18n key label for the button
 * @description
...
.component('yActionableSearchItem', {
    templateUrl: 'web/common/services/select/ySelectExtensions/yActionableSearchItemTemplate.html',
    require: {
        ySelect: '^ySelect',
        uiSelect: '^uiSelect'
    },

 ...
 *
 */
angular.module('iFrameManagerModule', ['functionsModule', 'translationServiceModule', 'ngResource', 'loadConfigModule', 'restServiceFactoryModule', 'sharedDataServiceModule', 'resourceLocationsModule', 'heartBeatServiceModule', 'eventServiceModule', 'waitDialogServiceModule'])
     ...
     */
    .factory("iFrameManager", function(deviceSupports, deviceOrientations, getURI, isBlank, $q, $log, $http, loadConfigManagerService, restServiceFactory, hitch, sharedDataService, heartBeatService, LANDING_PAGE_PATH, PREVIEW_RESOURCE_URI, $location, parseQuery, systemEventService, waitDialogService) {

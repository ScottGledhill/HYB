 ...
 *
 */
.factory('sharedDataService', function($q, gatewayProxy, SharedDataServiceInterface, extend) {
    ...
    SharedDataService.prototype.update = function(name, modifyingCallback) {
        return this.get(name).then(function(newValue) {
            return $q.when(modifyingCallback(newValue)).then(function(newValue) {

 ...
 */
describe('sliderPanelControllerTest', function() {
    ...
    beforeEach(function() {
        ...
        var harness = AngularUnitTestHelper.prepareModule('sliderPanelModule')
            .mock('sliderPanelServiceFactory', 'getNewServiceInstance').andCallFake(function() {
                return mockService;
            })
        ...
        //animate.removeClass.andReturn($q.when(true));
    });

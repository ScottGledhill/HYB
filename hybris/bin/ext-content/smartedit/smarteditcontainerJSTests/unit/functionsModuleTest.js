...
describe('test functionsModule', function() {
    ...
    var isBlank, hitch, copy, customTimeout, merge, getQueryString, parseQuery, trim, convertToArray, uniqueArray, regExpFactory, generateIdentifier, closeOpenModalsOnBrowserBack, $uibModalStack;
    ...
    it('closeOpenModalsOnBrowserBack will dismiss open modal windows if open', function() {
        ...
        $uibModalStack.getTop.andReturn({
            "modal1": "modal1"
        });

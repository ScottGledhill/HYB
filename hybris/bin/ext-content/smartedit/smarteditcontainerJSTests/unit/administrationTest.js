 ...
 */
describe('administrationModule Test - ', function() {

    var configurationEditor, $q, $rootScope, editorCRUDService;
    ...
    beforeEach(inject(function(_ConfigurationEditor_, _$q_, _$rootScope_) {
        ...
        configurationEditor.editorCRUDService.remove.andCallFake(function() {
            return $q.when(true);
        });
    }));

...
describe("Slider Panel >", function() {
    ...
    var componentObjects = require("../_componentObjects/sliderPanelComponentObjects.js"),
        pageObjects = require("./sliderPanelTestPageObjects.js");

    beforeEach(function() {
        browser.get("smarteditcontainerJSTests/e2e/sliderPanel/sliderPanelTest.html");
    });
    ...
    describe("Default Rendering:", function() {
        ...
        it("GIVEN the page contains a 'modal' slider panel " +
            ...
            function() {
                ...
                componentObjects.actions.waitForNonPresenceOfModalSliderPanel();

                expect(componentObjects.actions.checkPresenceOfModalSliderPanel().isPresent()).toBe(false);

...
describe("Authentication", function() {
    beforeEach(function() {
        page.getAndWaitForLogin('smarteditcontainerJSTests/e2e/apiAuthentication/apiAuthenticationTest.html');
    });
    afterEach(function() {
    ...
    describe('After Login', function() {
        ...
        it("WHEN the user is not authenticates to fake1 or fake2 API THEN fake 1 nor fake 2 are visible", function() {
    ...
    describe('Custom Iframe', function() {
        it("WHEN the user is logged in THEN the custom iframe successfully retrieves access token map", function() {
            ...
            login.loginAsCmsManager().then(function() {
                ...
                expect(element(by.id('tokens')).getText()).toBe("{\"/authorizationserver/oauth/token\":{\"access_token\":\"access-token0\",\"token_type\":\"bearer\"},\"principal-uid\":\"cmsmanager\"}");
            });
        });
    });
});

...
angular.module('backendMocks', ['ngMockE2E', 'functionsModule', 'resourceLocationsModule', 'languageServiceModule'])
    ...
    .run(function($httpBackend, filterFilter, parseQuery, URL_FOR_ITEM, I18N_RESOURCE_URI, languageService) {
        ...
        $httpBackend.whenGET(/sampleOptionsAPI0\/(.+)/).respond(function(method, url, data, headers) {
        ...
        $httpBackend.whenGET(/sampleOptionsAPI1/).respond(function(method, url, data, headers) {
        ...
        $httpBackend.whenGET(/sampleOptionsAPI2/).respond(function(method, url, data, headers) {
        ...
        $httpBackend.whenGET(/sampleOptionsAPI3/).respond(function(method, url, data, headers) {

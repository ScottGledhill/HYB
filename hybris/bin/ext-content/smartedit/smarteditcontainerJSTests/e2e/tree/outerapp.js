...
angular.module('outerapp', ['ui.bootstrap', 'ngRoute', 'treeModule', 'confirmationModalServiceModule'])
    ...
    .run(
        ['$templateCache', '$animate', function($templateCache, $animate) {
            ...
            $templateCache.put('web/smarteditcontainer/services/navigations/someTreeNodeRenderTemplate.html',
    ...
    .controller("someTreeEditorController", function($rootScope, confirmationModalService) {
        ...
        this.nodeTemplateUrl = 'web/smarteditcontainer/services/navigations/someTreeNodeRenderTemplate.html';
        ...
        this.actions = {
            ...
            addSiblingToFirstChild: function(treeService) {

...
describe('BasicSlotContextualMenuDecorator', function() {
    ...
    beforeEach(function() {
        page.getAndWaitForWholeApp('smarteditcontainerJSTests/e2e/basicSlotContextualMenu/basicSlotContextualMenuTest.html').then(function() {
    ...
    it('GIVEN I am in a mode in which the slot contextual menu decorator is enabled WHEN I hover over a non-empty slot THEN the border should be visible', function() {
        storefront.moveToComponent(storefront.TOP_HEADER_SLOT_ID).then(function() {

...
describe(
    ...
    function() {
        ...
        var $rootScope, $compile, parentScope, directiveScope, element, smarteditComponentType, smarteditComponentId, smarteditProperties;
        ...
        it('sakExecutor WILL process all decorators and will add smarteditProperties map to each scope', function() {
            decoratorService.getDecoratorsForComponent.andReturn(decorators);
            compileDirective();
            expect(element.find('[data-smartedit-properties]').length).toBe(2);
        });

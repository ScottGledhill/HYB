...
public class DefaultItemSynchronizationFacadeTest
{
	...
	@Mock
	private SyncRequestData syncRequestData = mock(SyncRequestData.class);
	@Mock
	...
	private String itemId2 = "itemId2";
	private String itemType2 = "itemType2";
	
	@Mock
	private ItemSynchronizationData itemData3;
	private String itemId3 = "itemId3";
	private String itemType3 = "itemType3";

	private ItemCollector contentPageItemCollector = mock(ItemCollector.class);

	private java.util.Optional<ItemCollector> contentPageItemCollectorOptional = Optional.of(contentPageItemCollector);
	private ItemCollector contentSlotItemCollector = mock(ItemCollector.class);
	private java.util.Optional<ItemCollector> contentSlotItemCollectorOptional = Optional.of(contentSlotItemCollector);
	...
	public void setup()
	{
		...
		{
			@Override
			public Optional<ItemModel> answer(InvocationOnMock invocation) throws Throwable
			{
	...
	{
		SyncConfig syncConfig = Mockito.mock(SyncConfig.class);

...
public class CMSComponentTypeModelMother extends AbstractModelMother<CMSComponentTypeModel>
{
	...
	public CMSComponentTypeModel NavigationComponent()
	{
		return getOrSaveAndReturn( //
				() -> cmsComponentTypeDao.getCMSComponentTypeByCode(NavigationComponentModel._TYPECODE), //
				() -> CMSComponentTypeModelBuilder.aModel() //
						.withCode(NavigationComponentModel._TYPECODE) //
						.build());
	}

...
public class ContentPageModelMother extends AbstractModelMother<ContentPageModel>
{
	...
	public static final String UID_EMAILPAGE = "uid-emailpage";
	...
	{
		return getOrSaveAndReturn( //
				() -> getContentPageDao().getByUidAndCatalogVersion(UID_EMAILPAGE, catalogVersion), //
				() -> ContentPageModelBuilder.aModel() //
				.withUid(UID_EMAILPAGE) //
				.withCatalogVersion(catalogVersion) //
				...
				.withDefaultPage(Boolean.FALSE) //
				.withLabel(LABEL_EMAILPAGE) //
				.withName(NAME_EMAILPAGE).build());
	}

	public ContentPageModel DefaultEmailPageFromHomePageTemplate(final CatalogVersionModel catalogVersion)
	{
		return getOrSaveAndReturn( //
				() -> getContentPageDao().getByUidAndCatalogVersion(UID_DEFAULT_EMAILPAGE, catalogVersion), //
				() -> ContentPageModelBuilder.aModel() //
				.withUid(UID_DEFAULT_EMAILPAGE) //
				.withCatalogVersion(catalogVersion) //
				.withMasterTemplate(pageTemplateModelMother.HomePage_Template(catalogVersion)) //
				.withThumbnail(mediaModelMother.createMediaModel(catalogVersion, THUMBNAIL)) //
				.withDefaultPage(Boolean.TRUE) //
	...
	public ContentPageModel somePage(final CatalogVersionModel catalogVersion, final String uid, final String nameTitle)
	{
		return getOrSaveAndReturn( //
				...
				.withCatalogVersion(catalogVersion) //
				.withMasterTemplate(pageTemplateModelMother.HomePage_Template(catalogVersion)) //
				.withThumbnail(mediaModelMother.createMediaModel(catalogVersion, THUMBNAIL)).withName(nameTitle + NAME_SUFFIX) //

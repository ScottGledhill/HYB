...
import de.hybris.platform.cmsfacades.util.builder.SimpleResponsiveBannerComponentModelBuilder;
import de.hybris.platform.cmsfacades.util.dao.impl.SimpleResponsiveBannerComponentDao;
...
public class SimpleResponsiveBannerComponentModelMother extends AbstractModelMother<SimpleResponsiveBannerComponentModel>
{
	...
	public SimpleResponsiveBannerComponentModel createSimpleResponsiveBannerComponentModel(
			final CatalogVersionModel catalogVersion)
	{
		return getOrSaveAndReturn(
				...
				() -> SimpleResponsiveBannerComponentModelBuilder.aModel().withUid(UID_HEADER_LOGO).withCatalogVersion(catalogVersion)
						...
						.withMedia(mediaContainerModelMother.createEmptyMediaContainerModel(catalogVersion), Locale.ENGLISH).build());
	}
	...
	public void setSimpleResponsiveBannerComponentDao(final SimpleResponsiveBannerComponentDao simpleResponsiveBannerComponentDao)
	{

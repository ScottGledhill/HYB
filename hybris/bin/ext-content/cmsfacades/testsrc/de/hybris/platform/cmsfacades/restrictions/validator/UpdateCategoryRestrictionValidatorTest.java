...
import de.hybris.platform.cmswebservices.dto.UpdateRestrictionValidationDto;
...
public class UpdateCategoryRestrictionValidatorTest
{
	...
	public void setUp()
	{
		List<String> categories = new ArrayList<String>(Arrays.asList(validKey));
	...
	{
		errors = new BeanPropertyBindingResult(data, data.getClass().getSimpleName());
		data.setCategories(new ArrayList<String>(Arrays.asList(invalidKey)));

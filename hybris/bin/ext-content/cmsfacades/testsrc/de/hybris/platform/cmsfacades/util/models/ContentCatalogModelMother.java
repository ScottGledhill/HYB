...
public class ContentCatalogModelMother extends AbstractModelMother<ContentCatalogModel>
{
	...
	{
		ID_APPLE("Apple's Content Catalog"), ID_ONLINE("online content catalog"), ID_STAGED("staged content catalog"),
		ID_PHONES("Phone Product Catalog"), ID_PHONE_ONLINE("online phone catalog"), ID_PHONE_STAGED_1("staged1 phone catalog"), ID_PHONE_STAGED_2("staged1 phone catalog"),
		ID_LAPTOPS("Laptop Product Catalog"), ID_LAPTOP_ONLINE("online laptop catalog"), ID_LAPTOP_STAGED_1("staged1 laptop catalog"), ID_LAPTOP_STAGED_2("staged1 laptop catalog");
	...
	public ContentCatalogModel createAppleContentCatalogModel(CatalogVersionModel... catalogVersions)
	{
		return getOrSaveAndReturn(() -> getCmsContentCatalogDao().findContentCatalogById(ID_APPLE.name()),
				() -> ContentCatalogModelBuilder.fromModel(defaultCatalog())
						.withName(ID_APPLE.getFirstInstanceOfHumanName(), Locale.ENGLISH).withId(ID_APPLE.name())

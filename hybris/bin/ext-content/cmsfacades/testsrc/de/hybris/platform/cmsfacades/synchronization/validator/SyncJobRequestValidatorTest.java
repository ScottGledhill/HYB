...
public class SyncJobRequestValidatorTest
{
	...
	public void setUp()
	{
		...
		Mockito.doReturn(isFindable(testTargetVersion)).when(validator).isFindableCatalogByIdVersion(testCatalog,
				testTargetVersion);
		Mockito.doReturn(isFindable(testSourceVersion)).when(validator).isFindableCatalogByIdVersion(testCatalog,
				testSourceVersion);

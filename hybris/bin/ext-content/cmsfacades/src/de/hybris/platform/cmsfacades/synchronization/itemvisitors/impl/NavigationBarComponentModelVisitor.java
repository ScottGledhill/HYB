...
/**
 * Concrete implementation of {@link AbstractCMSComponentModelVisitor} to visit items of the {@link NavigationBarComponentModel} types.
 *
...
public class NavigationBarComponentModelVisitor extends AbstractCMSComponentModelVisitor<NavigationBarComponentModel>
{
	...
	@Override
	public List<ItemModel> visit(NavigationBarComponentModel source, List<ItemModel> path, Map<String, Object> ctx)
	{

...
public interface PageRestrictionFacade
{
	 ...
	 *
	 * @param pageId
	 *           - the page containing the restrictions
	 ...
	 *
	 * @param pageId
	 *           is the id of the page for which the list of {@link pageRestrictionsListData} is being updated
	 * @param pageRestrictionsListData
	 *           is the list of page-restriction relation
	 * @throws CMSItemNotFoundException

...
/**
 * Concrete implementation of {@link AbstractCMSComponentModelVisitor} to visit items of the {@link NavigationBarCollectionComponentModel} types.
 *
 ...
 */
public class NavigationBarCollectionComponentModelVisitor extends AbstractCMSComponentModelVisitor<NavigationBarCollectionComponentModel>
{

	@Override
	public List<ItemModel> visit(NavigationBarCollectionComponentModel source, List<ItemModel> path, Map<String, Object> ctx)
	{

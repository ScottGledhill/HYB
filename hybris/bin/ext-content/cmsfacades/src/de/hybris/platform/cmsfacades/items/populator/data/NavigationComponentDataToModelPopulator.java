 ...
 */
public class NavigationComponentDataToModelPopulator implements Populator<NavigationComponentData, NavigationComponentModel>
{

	private CMSNavigationService navigationService;

	@Override
	public void populate(final NavigationComponentData source, final NavigationComponentModel target) throws ConversionException
	{
		try
		{
		...
		target.setWrapAfter(StringUtils.isNotBlank(source.getWrapAfter()) ? Integer.parseInt(source.getWrapAfter()) : null);
	}

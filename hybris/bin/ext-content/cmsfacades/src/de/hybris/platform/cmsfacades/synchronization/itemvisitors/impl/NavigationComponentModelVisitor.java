...
/**
 * Concrete implementation of {@link AbstractCMSComponentModelVisitor} to visit items of the {@link NavigationComponentModel} types.
 *
...
public class NavigationComponentModelVisitor extends AbstractCMSComponentModelVisitor<NavigationComponentModel>
{
	...
	@Override
	public List<ItemModel> visit(NavigationComponentModel source, List<ItemModel> path, Map<String, Object> ctx)
	{

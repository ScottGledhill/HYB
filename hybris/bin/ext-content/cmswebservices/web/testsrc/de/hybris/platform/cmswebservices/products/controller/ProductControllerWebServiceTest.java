...
public class ProductControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void setup()
	{
		...
		productModelMother.createDefaultProduct(catalogVersion);
	}
	...
	public void testGetProductByCode()
	{
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				...
				.path(ProductModelMother.PRODUCT)
				.build()
	...
	protected void assertOnProductData(final ProductWsDTO categoryWsDTO)
	{
		assertThat(
				categoryWsDTO,

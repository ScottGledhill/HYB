...
public class PageContentSlotComponentControllerAddAndRemoveWebServiceTest extends ApiBaseIntegrationTest
{
	...
	public void shouldAddComponentToSlot_FirstPosition() throws Exception
	{
		...
		final PageContentSlotComponentData entity = buildBannerContentSlotComponentItemDto(0, ContentSlotModelMother.UID_HEADER);
	...
	{
		createAppleCatalogWithHeaderParagraphOnly();
		final PageContentSlotComponentData entity = buildBannerContentSlotComponentItemDto(5, ContentSlotModelMother.UID_HEADER);
	...
	public void shouldAddComponentToSlot_FailedTypeRestriction() throws Exception
	{
		...
		final PageContentSlotComponentData entity = buildParagraphContentSlotComponentItemDto(0, ContentSlotModelMother.UID_LOGO);
	...
	{
		createAppleCatalogWithHeaderParagraphOnly();
		final PageContentSlotComponentData entity = buildBannerContentSlotComponentItemDto(0, ContentSlotModelMother.UID_FOOTER);
	...
	{
		createAppleCatalogWithHeaderParagraphOnly();
		final PageContentSlotComponentData entity = buildInvalidPageBannerComponentItemDto(0, ContentSlotModelMother.UID_HEADER);
	...
	{
		createAppleCatalogWithHeaderParagraphOnly();
		final PageContentSlotComponentData entity = buildBannerContentSlotComponentItemDto(-3, ContentSlotModelMother.UID_HEADER);

...
import de.hybris.platform.cmsfacades.util.models.CMSCategoryRestrictionModelMother;
import de.hybris.platform.cmsfacades.util.models.CMSTimeRestrictionModelMother;
import de.hybris.platform.cmsfacades.util.models.CMSUserGroupRestrictionModelMother;
import de.hybris.platform.cmsfacades.util.models.CatalogVersionModelMother;
import de.hybris.platform.cmsfacades.util.models.CategoryModelMother;
import de.hybris.platform.cmsfacades.util.models.ProductCatalogModelMother;
...
public class RestrictionsControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	private static final String INVALID_DATE_RANGE = "The dates and times provided are not valid. The end date-time must be greater than the start date-time.";
	...
	@Test
	public void shouldFailCreateTimeRestrictionInvalidDateRange() throws ParseException, JAXBException
	{
		final Date activeFrom = simpleDateFormat.parse("2016-11-25 00:00:00");
	...
	public void shouldSearchAndReturnFullFirstPage_noFilterAndSortByName()
	{
		...
		assertThat("page 0 (no filter, no sort) failed to return the maximum number of results",
				restrictionsList.getPagination().getTotalCount(), equalTo(3));
	...
	public void shouldSearchAndReturnFullFirstPage_withFilterAndSortByName()
	{
		...
		assertThat("page 0 (filter, name sort) failed to return the maximum number of results",
				restrictionsList.getPagination().getTotalCount(), equalTo(2));
	...
	public void shouldSearchAndReturnNoResult_withFilterAndSortByName()
	{
		...
		assertThat("page 0 (filter, name sort) failed to return the maximum number of results",
				restrictionsList.getPagination().getTotalCount(), equalTo(0));
	}

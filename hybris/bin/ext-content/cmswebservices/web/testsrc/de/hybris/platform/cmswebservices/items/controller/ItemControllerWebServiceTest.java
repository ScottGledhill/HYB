...
import de.hybris.platform.cmsfacades.util.models.SimpleResponsiveBannerComponentModelMother;
...
public class ItemControllerWebServiceTest extends ApiBaseIntegrationTest
{
	...
	protected void createElectronicsSiteAndHomeAppleCatalogPageHeaderWithParagraph_WithNavigationTypeRestrictions()
	{
		...
		contentSlotForPageModelMother.HeaderHomepage_ParagraphOnly(catalogVersion);
		// Create header content slot name with paragraph and banner type restrictions
		contentSlotNameModelMother.Header_with_navigations(pageTemplate);
	}

	protected void createNavigationNodes()
	{
		final Collection<CatalogVersionModel> catalogVersions = Arrays.asList(catalogVersion);
	...
	public void shouldGetAllItemsAndAllItemsArePresentOnTheRightOrder() throws Exception
	{
		...
		Assert.assertTrue("The response should return a list in descending order by modification time. ", headerParagraph
				.getModifiedtime().after(headerBanner.getModifiedtime()));
	}

	protected List<AbstractCMSComponentData> executeGetAllItems() throws Exception
	{
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(GET_ALL_ENDPOINT, new HashMap<>())).build() //
	...
	{
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(GET_ALL_ENDPOINT, new HashMap<>()))
	...
	public void shouldGetOneItem() throws Exception
	{
		...
		final String endPoint = replaceUriVariablesWithDefaults(GET_ONE_ENDPOINT, uriVariables);
	...
	public void shouldReturnHttpStatus404DueToItemNotFound() throws Exception
	{
		...
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(GET_ONE_ENDPOINT, uriVariables)).build() //
				.accept(MediaType.APPLICATION_JSON) //
				.get();
	...
	public void shouldUpdateOneItemExceptUID() throws Exception
	{
		...
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(UPDATE_ITEM_ENDPOINT, uriVariables)).build() //
				.accept(MediaType.APPLICATION_JSON) //
	...
	public void shouldRemoveAnItem() throws Exception
	{
		...
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(REMOVE_ITEM_ENDPOINT, uriVariables)).build() //
				.accept(MediaType.APPLICATION_JSON) //
				.delete();
	...
	public void shouldNotUpdateItemDueToNoTypeCodeProvided() throws Exception
	{
		...
		final Map<String, String> uriVariables = new HashMap<>();
		uriVariables.put(UID, ParagraphComponentModelMother.UID_HEADER);
		final String endpoint = replaceUriVariablesWithDefaults(UPDATE_ITEM_ENDPOINT, uriVariables);
	...
	public void shouldCreateNewComponentBasedOnType() throws Exception
	{
		...
		final Response response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(CREATE_ITEM_ENDPOINT, new HashMap<>())).build() //
				.accept(MediaType.APPLICATION_JSON) //
	...
	public void shouldGetEmptyMediaContainerFromSimpleResponsiveBannerComponent() throws Exception
	{
		...
		final SimpleResponsiveBannerComponentData entity = response.readEntity(SimpleResponsiveBannerComponentData.class);

		assertEquals(SimpleResponsiveBannerComponentModel._TYPECODE, entity.getTypeCode());
		assertEquals(SimpleResponsiveBannerComponentModelMother.UID_HEADER_LOGO, entity.getUid());
		assertEquals(SimpleResponsiveBannerComponentModelMother.NAME_HEADER_LOGO, entity.getName());
		assertThat(entity.getMedia().get(MediaFormatModelMother.WIDESCREEN), is(nullValue()));
		assertThat(entity.getMedia().get(MediaFormatModelMother.DESKTOP), is(nullValue()));
		assertThat(entity.getMedia().get(MediaFormatModelMother.TABLET), is(nullValue()));
		assertThat(entity.getMedia().get(MediaFormatModelMother.MOBILE), is(nullValue()));
	}
	...
	public void shouldAddMediaContainerToSimpleResponsiveBannerMultipleLanguages() throws Exception
	{
		...
		final String getEndpoint = replaceUriVariablesWithDefaults(GET_ONE_ENDPOINT, uriVariables);
		final String updateEndpoint = replaceUriVariablesWithDefaults(UPDATE_ITEM_ENDPOINT,
				uriVariables);
		...
		final Response putResponse = getCmsManagerWsSecuredRequestBuilder()
				//
				.path(updateEndpoint)
				.build()
				//
				.accept(MediaType.APPLICATION_JSON)
				//
				.put(Entity.entity(marshallDto(componentData, SimpleResponsiveBannerComponentData.class), MediaType.APPLICATION_JSON));

		assertResponse(Status.NO_CONTENT, putResponse);

		final Response responseGet = getCmsManagerWsSecuredRequestBuilder() //
				.path(getEndpoint).build() //
				.accept(MediaType.APPLICATION_JSON) //
				.get();

		assertResponse(Status.OK, responseGet);

		final SimpleResponsiveBannerComponentData entity = responseGet.readEntity(SimpleResponsiveBannerComponentData.class);
		assertEquals(SimpleResponsiveBannerComponentModel._TYPECODE, entity.getTypeCode());
		assertEquals(SimpleResponsiveBannerComponentModelMother.UID_HEADER_LOGO, entity.getUid());
		assertEquals(SimpleResponsiveBannerComponentModelMother.NAME_HEADER_LOGO, entity.getName());
		assertThat(entity.getMedia(), instanceOf(Map.class));
		final Map<String, Map<String, String>> localizedValueData = entity.getMedia();

		assertThat(localizedValueData.size(), is(2));

		final Map<String, String> formatCodesEnglish = localizedValueData.get(ENGLISH.getLanguage());
		...
		final Map<String, String> formatCodesFrench = localizedValueData.get(FRENCH.getLanguage());
	...
	public void shouldRemoveMobileMediaFromContainer() throws Exception
	{
		createDefaultMediaFormats();
		createElectronicsSiteAndHomeAppleCatalogPageHeaderWithParagraphWithoutRestriction();
		simpleResponsiveBannerComponentModelMother.createSimpleResponsiveBannerComponentModelWithLogoMedia(catalogVersion);
		...
		assertEquals(SimpleResponsiveBannerComponentModelMother.UID_HEADER_LOGO, entity.getUid());
		assertEquals(SimpleResponsiveBannerComponentModelMother.NAME_HEADER_LOGO, entity.getName());
		final Map<String, String> formatCodesEnglish = entity.getMedia().get(ENGLISH.getLanguage());
		assertThat(formatCodesEnglish.get(MediaFormatModelMother.WIDESCREEN), is(MediaModelMother.MediaTemplate.LOGO.getCode()
				+ "-" + MediaFormatModelMother.WIDESCREEN));
		assertThat(formatCodesEnglish.get(MediaFormatModelMother.DESKTOP), nullValue());
	...
	public void shouldGetMultipleComponentItems_MultipleValidUidsInUidsParameter() throws Exception
	{
		...
		final Response response = getCmsManagerWsSecuredRequestBuilder()
				...
				.queryParam(UIDS_REQUEST_PARAMETER,
						ParagraphComponentModelMother.UID_HEADER + "," + SimpleBannerComponentModelMother.UID_HEADER_LOGO).build() //
				.accept(MediaType.APPLICATION_JSON) //
				.get();
	...
	@Test
	public void shouldCreateNavigationComponent() throws Exception
	{
		createElectronicsSiteAndHomeAppleCatalogPageHeaderWithParagraph_WithNavigationTypeRestrictions();
		createNavigationNodes();
		final Response response = createNavigationComponent();

		assertResponse(Status.CREATED, response);

		final NavigationComponentData entity = response.readEntity(NavigationComponentData.class);
		assertThat(entity.getUid(), notNullValue());
	}

	@Test
	public void shouldDeleteNavigationComponent() throws Exception
	{
		createElectronicsSiteAndHomeAppleCatalogPageHeaderWithParagraph_WithNavigationTypeRestrictions();
		createNavigationNodes();

		Response response = createNavigationComponent();
		...
		final Map<String, String> uriVariables = new HashMap<>();
		uriVariables.put(UID, entity.getUid());
	...
	@Test
	public void shouldFailToUpdateNavigationComponent_invalidNavigationNode() throws Exception
	{
		createElectronicsSiteAndHomeAppleCatalogPageHeaderWithParagraph_WithNavigationTypeRestrictions();
		createNavigationNodes();
		...
		entity.setNavigationNode("invalid-navigation-node-ui");
		response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(UPDATE_ITEM_ENDPOINT, uriVariables)).build() //
				.accept(MediaType.APPLICATION_JSON) //
				.put(Entity.entity(marshallDto(entity, NavigationComponentData.class), MediaType.APPLICATION_JSON));

		assertResponse(Status.INTERNAL_SERVER_ERROR, response);
	...
	@Test
	public void shouldUpdateNavigationComponent() throws Exception
	{
		createElectronicsSiteAndHomeAppleCatalogPageHeaderWithParagraph_WithNavigationTypeRestrictions();
		createNavigationNodes();
		...
		// update navigation node uid
		entity.setNavigationNode(NAVIGATION_NODE_UID);
		response = getCmsManagerWsSecuredRequestBuilder() //
				.path(replaceUriVariablesWithDefaults(UPDATE_ITEM_ENDPOINT, uriVariables)).build() //
				.accept(MediaType.APPLICATION_JSON) //
				.put(Entity.entity(marshallDto(entity, NavigationComponentData.class), MediaType.APPLICATION_JSON));
		...
		final NavigationComponentData entityGet = response.readEntity(NavigationComponentData.class);
		assertThat(entityGet.getNavigationNode(), is(NAVIGATION_NODE_UID));
	}

	protected Map<String, Map<String, String>> getMediaContainerLocalizedValueMapDataWidescreen()
	{
	...
	protected Map<String, Map<String, String>> getMediaContainerLocalizedValueMapData()
	{
		final MediaModel mediaWidescreen = mediaModelMother.createLogoMediaModelWithCode(catalogVersion, MEDIA_WIDESCREEN);
	...
	protected void createDefaultMediaFormats()
	{
	...
	protected Response createNavigationComponent() throws JAXBException
	{
		final String nameNewComponent = "name-new-component-added";

		final NavigationComponentData component = new NavigationComponentData();
		component.setName(nameNewComponent);
		component.setUid(nameNewComponent);
		component.setSlotId(ContentSlotModelMother.UID_HEADER);
		component.setTypeCode(NavigationComponentModel._TYPECODE);
		component.setPosition(0);
		component.setPageId(PAGE_ID);
		component.setNavigationNode(NAVIGATION_NODE_UID);

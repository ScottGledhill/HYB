...
public class CategoryController
{
	...
	@ResponseBody
	public CategoryDataListWsDTO findProductCategoriesByText(@RequestParam(required = false) final String text,
			@ModelAttribute final PageableWsDTO pageableDto)
	{
		final SearchResult<CategoryData> productSearchResult = getCmsProductSearchFacade().findProductCategories(text, Optional.of(pageableDto)

angular.module('personalizationsmarteditCombinedViewComponentLightUpDecorator', ['personalizationsmarteditTemplates', 'personalizationsmarteditContextServiceModule'])
    .directive('personalizationsmarteditCombinedViewComponentLightUp', function(personalizationsmarteditContextService, PERSONALIZATION_COMBINED_VIEW_CSS_MAPPING) {
        return {
            templateUrl: 'web/features/personalizationsmartedit/combinedView/personalizationsmarteditCombinedViewComponentLightUpDecoratorTemplate.html',
            restrict: 'C',
            transclude: true,
            replace: false,
            scope: {
            ...
            link: function($scope, element, attrs) {
                ...
                $scope.getPersonalizationComponentBorderClass = function() {
                    ...
                    if (combinedView.enabled) {
                        var container = element.parent().closest('[class~="smartEditComponentX"][data-smartedit-container-id][data-smartedit-container-type="CxCmsComponentContainer"][data-smartedit-personalization-customization-id][data-smartedit-personalization-variation-id]');

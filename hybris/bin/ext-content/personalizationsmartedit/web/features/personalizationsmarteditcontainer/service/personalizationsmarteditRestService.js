angular.module('personalizationsmarteditRestServiceModule', ['restServiceFactoryModule', 'personalizationsmarteditCommons', 'personalizationsmarteditContextServiceModule'])
    .factory('personalizationsmarteditRestService', function(restServiceFactory, personalizationsmarteditUtils, personalizationsmarteditContextService, $http) {
        ...
        var VARIATION_FOR_CUSTOMIZATION_FIELDS = ["active", "enabled", "code", "name", "rank", "status"];
        ...
        restService.getPromotions = function() {
            var experienceData = personalizationsmarteditContextService.getSeExperienceData();

describe('personalizationsmarteditCommerceCustomizationViewController', function() {
    ...
    var personalizationsmarteditCommerceCustomizationViewController, scope, $q;
    ...
    beforeEach(module('personalizationsmarteditContextServiceModule', function($provide) {
        personalizationsmarteditContextService = jasmine.createSpyObj('personalizationsmarteditContextService', ['getSeConfigurationData']);
    ...
    beforeEach(inject(function($controller, _$rootScope_, _$q_) {
        ...
        personalizationsmarteditRestService.getActions.andReturn(
            _$q_.defer().promise
        );

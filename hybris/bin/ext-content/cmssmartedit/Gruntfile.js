...
module.exports = function(grunt) {
    ...
    grunt.initConfig({
         ...
         */
        jsbeautifier: {
            files: ['Gruntfile.js', 'web/features/**/*.js', testJsFiles, 'web/features/**/*.html', 'web/styling/**/*.css'],
            options: {
        ...
        jssemicoloned: {
            files: ['Gruntfile.js', 'web/features/**/*.js', testJsFiles]
        },
        clean: {
            temp: {
                src: ['tmp', 'jsTarget']
        ...
        jshint: {
            ...
            all: ['Gruntfile.js', 'web/features/**/*.js', testJsFiles]
        },

 ...
 */
.service('pagesRestService', function(restServiceFactory, lodash, URIBuilder, CONTEXT_SITE_ID, CONTEXT_CATALOG, CONTEXT_CATALOG_VERSION) {
    var URI = '/cmswebservices/v1/sites/' + CONTEXT_SITE_ID + '/catalogs/' + CONTEXT_CATALOG + '/versions/' + CONTEXT_CATALOG_VERSION + '/pages/:pageUid';
    ...
    this.get = function(params) {
        ...
        delete params[CONTEXT_SITE_ID];
        delete params[CONTEXT_CATALOG];
        delete params[CONTEXT_CATALOG_VERSION];
        return restServiceFactory.get(uri, 'pageUid').get(params).then(function(response) {
    ...
    this.getById = function(pageUid, params) {
        ...
        delete extendedParams[CONTEXT_SITE_ID];
        delete extendedParams[CONTEXT_CATALOG];
        delete extendedParams[CONTEXT_CATALOG_VERSION];

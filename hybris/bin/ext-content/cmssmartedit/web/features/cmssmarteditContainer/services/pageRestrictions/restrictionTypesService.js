 ...
 * @description
 * This module provides a service used to consolidate business logic for SAP Hybris platform CMS restriction types for
 * both pages and components.
 */
angular.module('restrictionTypesServiceModule', ['pageTypesRestrictionTypesServiceModule', 'restrictionTypesRestServiceModule'])


/**
 * @ngdoc service
 * @name restrictionTypesServiceModule.restrictionTypesService
 *
 * @description
 ...
 */
.service('restrictionTypesService', function($q, languageService, pageTypesRestrictionTypesService, restrictionTypesRestService) {
    ...
    /**
     * @ngdoc method
     * @name restrictionTypesServiceModule.restrictionTypesService.getRestrictionTypesByPageType
     * @methodOf restrictionTypesServiceModule.restrictionTypesService
     *
    ...
    /**
     * @ngdoc method
     * @name restrictionTypesServiceModule.restrictionTypesService.getRestrictionTypes
     * @methodOf restrictionTypesServiceModule.restrictionTypesService
     *
    ...
    /**
     * @ngdoc method
     * @name restrictionTypesServiceModule.restrictionTypesService.getRestrictionTypeForTypeCode
     * @methodOf restrictionTypesServiceModule.restrictionTypesService
     *

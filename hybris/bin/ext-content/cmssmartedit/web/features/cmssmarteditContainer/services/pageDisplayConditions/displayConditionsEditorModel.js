 ...
 */
angular.module('displayConditionsEditorModelModule', ['displayConditionsFacadeModule'])
    .service('displayConditionsEditorModel', function(displayConditionsFacade, $q) {

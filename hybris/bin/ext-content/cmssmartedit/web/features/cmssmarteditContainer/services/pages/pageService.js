 ...
 *
 */
angular.module('pageServiceModule', ['pagesRestServiceModule', 'pagesFallbacksRestServiceModule', 'pagesVariationsRestServiceModule', 'yLoDashModule'])
 ...
 */
.service('pageService', function(pagesRestService, pagesFallbacksRestService, pagesVariationsRestService, lodash, $q) {
     ...
     * @param {String} pageUid The UID of the page
     *
     * @returns {Promise} A promise that resolves to the JSON page object corresponding to this page UID
     */

 ...
 * @description
 * This module provides a service used to consolidate business logic for SAP Hybris platform CMS
 * pageTypes-restrictionTypes relations.
 */
angular.module('pageTypesRestrictionTypesServiceModule', ['pageTypesRestrictionTypesRestServiceModule'])

/**
 * @ngdoc service
 * @name pageTypesRestrictionTypesServiceModule.pageTypesRestrictionTypesService
 *
 * @description
 * Service that concerns business logic tasks related to CMS pageTypes-restrictionTypes relations.
 */
.service('pageTypesRestrictionTypesService', function(pageTypesRestrictionTypesRestService) {
    ...
    /**
     * @ngdoc method
     * @name pageTypesRestrictionTypesServiceModule.pageTypesRestrictionTypesService.getRestrictionTypeCodesForPageType
     * @methodOf pageTypesRestrictionTypesServiceModule.pageTypesRestrictionTypesService
     *
    ...
    /**
     * @ngdoc method
     * @name pageTypesRestrictionTypesServiceModule.pageTypesRestrictionTypesService.getPageTypesRestrictionTypes
     * @methodOf pageTypesRestrictionTypesServiceModule.pageTypesRestrictionTypesService
     *

...
angular.module('catalogAwareSelectorModule', ['itemSelectorPanelModule', 'yEditableListModule'])
    .controller('CatalogAwareSelectorController', function($q, $log, $translate, lodash) {
        ...
        // Constants
        var DEFAULT_ITEM_TYPE_KEY = 'se.catalogaware.catalogitemtype.default';
...
.component('seCatalogAwareSelector', {
    templateUrl: 'web/features/cmssmarteditContainer/components/genericEditor/catalog/components/catalogAwareSelector/catalogAwareSelectorTemplate.html',

...
angular.module("navigationNodeEditorCreateEntryModule", [
    ...
    .service("navigationEntryStructureService", function($q, $translate) {
        ...
        this.getGenericEditorTabStructure = function() {
            var tabStructure = [{
                i18nKey: 'navigationmanagement.navnode.node.create.entry',
                cmsStructureType: "EditableDropdown",
                qualifier: "itemSuperType",
                placeholder: $translate.instant('navigationmanagement.navnode.node.entry.dropdown.title'),
                required: true
            }, {
    ...
    .factory('cmsNavigationEntryDropdownPopulator', function(DropdownPopulatorInterface, $q, extend, navigationNodeEntryTypesService) {
        ...
        cmsNavigationEntryDropdownPopulator.prototype.populate = function(payload) {
            _getDropdownOptions();
    ...
    .controller("navigationNodeEditorCreateEntryController", function($timeout, NAVIGATION_MANAGEMENT_ENTRIES_RESOURCE_URI, GENERIC_EDITOR_UNRELATED_VALIDATION_ERRORS_EVENT, GENERIC_EDITOR_LOADED_EVENT, NAV_ENTRY_EDITOR_ID, systemEventService, LINKED_DROPDOWN, lodash, navigationEntryStructureService, navigationEntriesRestService, URIBuilder) {
            ...
            return this.submit().then(
                function(data) {
                    if (data.itemId) {
                        ...
                        systemEventService.sendAsynchEvent(GENERIC_EDITOR_UNRELATED_VALIDATION_ERRORS_EVENT, [{
                            "message": "navigationmanagement.node.addentry.no.itemid.message",
                            "subject": "itemId",
        ...
        var eventId = this.tabId + LINKED_DROPDOWN;
        ...
        systemEventService.registerEventHandler(DELETE_ENTRY_EVENT, _deleteEntryEvent);
        ...
        this.$onDestroy = function() {
            ...
            systemEventService.unRegisterEventHandler(DELETE_ENTRY_EVENT, _deleteEntryEvent);
        };
    ...
    .directive('navigationNodeEditorCreateEntry', function() {
        ...
        return {
            ...
            transclude: false,
            replace: false,
            templateUrl: 'web/features/cmssmarteditContainer/components/navigation/navigationNodeEditor/navigationNodeEditorComponents/navigationNodeEditorCreateEntryTemplate.html',

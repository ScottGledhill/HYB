...
angular.module('syncPageModalServiceModule', ['modalServiceModule', 'pageSynchronizationPanelModule'])
     ...
     *
     */
    .factory('syncPageModalService', function(modalService, MODAL_BUTTON_ACTIONS, MODAL_BUTTON_STYLES, $log) {
         ...
         * @param {Object} uriContext An object containing the CURRENT_CONTEXT_SITE_ID, the CURRENT_CONTEXT_CATALOG and the CURRENT_CONTEXT_CATALOG_VERSION
         *
        ...
        SyncModalService.prototype.open = function(page, uriContext) {
            ...
            return modalService.open({
                ...
                titleSuffix: 'pageeditormodal.editpagetab.title',

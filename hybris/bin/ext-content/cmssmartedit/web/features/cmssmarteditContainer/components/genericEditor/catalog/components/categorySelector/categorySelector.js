...
angular.module('categorySelectorModule', ['catalogAwareSelectorModule', 'catalogInformationServiceModule'])
     ...
     */
    .constant('CATEGORY_TEMPLATE_FOR_SELECTOR', 'web/features/cmssmarteditContainer/components/genericEditor/catalog/components/categorySelector/categoryTemplate.html')
    ...
    .component('seCategorySelector', {
        templateUrl: 'web/features/cmssmarteditContainer/components/genericEditor/catalog/components/categorySelector/categorySelectorTemplate.html',

...
angular.module('componentMenuModule', ['componentsModule', 'componentServiceModule', 'assetsServiceModule', 'cmsDragAndDropServiceModule'])
    .controller('ComponentMenuController', function($log, $timeout, ComponentService, cmsDragAndDropService) {
        ...
        ComponentService.loadComponentTypes().then(function(componentTypes) {
            this.types = componentTypes;
        }.bind(this));
    ...
    .directive('componentMenu', function($rootScope, systemEventService, $q, $document, assetsService, cmsDragAndDropService, DRAG_AND_DROP_EVENTS) {
        return {
            templateUrl: 'web/features/cmssmarteditContainer/components/cmsComponents/componentMenu/componentMenuWidgetTemplate.html',
            restrict: 'E',
            transclude: true,
            $scope: {},

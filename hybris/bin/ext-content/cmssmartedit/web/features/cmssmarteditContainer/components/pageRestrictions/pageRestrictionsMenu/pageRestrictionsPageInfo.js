 ...
 */
angular.module('restrictionsPageInfoModule', ['componentHandlerServiceModule', 'pageListServiceModule'])

.controller('restrictionsPageInfoController', function() {

    this.associatedPrimaryPageLabelI18nKey = "se.label.page.primary";
    ...
    this.pageDisplayConditionsLabelI18nKey = "se.label.page.display.conditions";
...
.directive('restrictionsPageInfo', function() {
    return {
        templateUrl: 'web/features/cmssmarteditContainer/components/pageRestrictions/pageRestrictionsMenu/pageRestrictionsPageInfoTemplate.html',
        restrict: 'E',

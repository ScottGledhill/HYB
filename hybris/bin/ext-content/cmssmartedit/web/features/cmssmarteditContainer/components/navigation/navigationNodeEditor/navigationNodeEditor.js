...
.controller("navigationNodeEditorController", function() {
    this.navigationNodeEntryData = {
        ...
        prepareEntryNodeEditor: function(entry) {}
    };
})
...
.directive('navigationNodeEditor', function() {
    return {
        ...
        transclude: false,
        replace: false,
        templateUrl: 'web/features/cmssmarteditContainer/components/navigation/navigationNodeEditor/navigationNodeEditorTemplate.html',

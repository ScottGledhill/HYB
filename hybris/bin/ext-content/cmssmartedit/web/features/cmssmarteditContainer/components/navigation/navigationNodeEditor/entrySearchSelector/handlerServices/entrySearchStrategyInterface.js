...
angular.module('entrySearchStrategyInterfaceModule', [])
    ...
    .factory('EntrySearchStrategyInterface', function() {
         ...
         */
        EntrySearchStrategyInterface.prototype.getItem = function(id, parameters) {
         ...
         * @param {Object} parameters the {@link resourceLocationsModule.object:UriContext UriContext} necessary to perform operations
         */
        EntrySearchStrategyInterface.prototype.getSearchResults = function(mask, parameters) {};
         ...
         * @param {Object} parameters the {@link resourceLocationsModule.object:UriContext UriContext} necessary to perform operations
         */
        EntrySearchStrategyInterface.prototype.getPage = function(mask, pageSize, currentPage, parameters) {};

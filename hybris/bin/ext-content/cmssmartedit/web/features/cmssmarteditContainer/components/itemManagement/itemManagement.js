 ...
 */
angular.module('itemManagementModule', ['functionsModule', 'urlServiceModule'])

.controller('ItemManagementController', function($q, urlService) {

    var supportedModes = ['add', 'edit', 'create'];

    this._submitInternal = function _submitInternal() {
...
.component('itemManager', {
    ...
    templateUrl: 'web/features/cmssmarteditContainer/components/itemManagement/itemManagementTemplate.html',
    bindings: {
        // in
        item: '<',
        uriContext: '<',

...
angular.module('itemSelectorPanelModule', ['sliderPanelModule', 'l10nModule', 'recompileDomModule'])
    .controller('ItemSelectorPanelController', function($q, $element, lodash) {
        ...
        // Variables
        this.catalogInfo = {};
        this.catalogItemTemplate = "web/features/cmssmarteditContainer/components/genericEditor/catalog/components/itemSelectorPanel/catalogItemTemplate.html";
            ...
            this.sliderConfiguration = {
                ...
                modal: {
                    ...
                    cancel: {
                        ...
                        label: 'se.catalogaware.panel.button.cancel'
                    },
                    save: {
                        onClick: this._saveItemChanges,
                        label: 'se.catalogaware.panel.button.add',
    ...
    .component('seItemSelectorPanel', {
        templateUrl: 'web/features/cmssmarteditContainer/components/genericEditor/catalog/components/itemSelectorPanel/itemSelectorPanelTemplate.html',

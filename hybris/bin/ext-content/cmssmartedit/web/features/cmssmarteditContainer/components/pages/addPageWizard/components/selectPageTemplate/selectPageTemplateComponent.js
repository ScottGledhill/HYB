...
.component('selectPageTemplate', {
    ...
    templateUrl: 'web/features/cmssmarteditContainer/components/pages/addPageWizard/components/selectPageTemplate/selectPageTemplateTemplate.html',
    bindings: {
        uriContext: '<',
        pageTypeCode: '<',
        onTemplateSelected: '<'
...
.controller('selectPageTemplateController', ['pageTemplateService', '$rootScope', function(pageTemplateService, $rootScope) {
    ...
    this.$onInit = function onInit() {
        $rootScope.$watch(function() {
            return self.pageTypeCode;
        }, function() {
            self._onInputUpdated();
        });
    };

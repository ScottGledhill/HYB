 ...
 */
angular.module('navigationNodeEditorModalServiceModule', ['modalServiceModule'])
    /**
     * @ngdoc service
     ...
     *
     */
    .factory('navigationNodeEditorModalService', function(modalService, MODAL_BUTTON_STYLES, MODAL_BUTTON_ACTIONS) {
        ...
        NavigationNodeEditorModalService.prototype.openNodeEditor = function(target, uriContext) {
            return modalService.open({
                title: 'navigationmanagement.node.edit.title',
                templateUrl: 'web/features/cmssmarteditContainer/components/navigation/navigationNodeEditor/navigationNodeEditorModalTemplate.html',
                controller: ['$scope', 'modalManager', function($scope, modalManager) {
                    this.target = target;
                    this.uriContext = uriContext;

                    this.init = function() {
                        modalManager.setDismissCallback(this.reset);
                ...
                buttons: [{
                    id: 'cancel',
                    label: 'navigationmanagement.node.edit.cancel',
                    style: MODAL_BUTTON_STYLES.SECONDARY,
                    action: MODAL_BUTTON_ACTIONS.DISMISS
                }, {
                    id: 'save',
                    label: 'navigationmanagement.node.edit.save',

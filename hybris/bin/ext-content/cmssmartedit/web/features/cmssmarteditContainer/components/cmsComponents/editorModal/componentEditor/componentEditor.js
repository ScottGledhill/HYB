 ...
 */
angular.module('componentEditorModule', ['yLoDashModule', 'componentServiceModule'])
    /**
     * @ngdoc service
    ...
    .factory('componentEditorService', function($q, lodash, ComponentService) {
        ...
        var ComponentEditor = (function() {
            ...
            function _prepareFullPayload(payload) {
                ...
                lodash.forEach(this._partialPayload, function(tabContent, tab) {
            ...
            ComponentEditor.prototype.registerTab = function(tabId, componentInfo) {
                ...
                this._componentInfo = (lodash.isEmpty(this._componentInfo)) ? componentInfo : this._componentInfo;
            };
         ...
         * 
         * 
         * @param {String} [componentId=0] componentId The identifier of the associated component
         */
        this.getInstance = function(componentId) {
            componentId = (componentId) ? componentId : 0;

            for (var cId in _instances) {
                if (cId.toString() === componentId.toString()) {
                    return _instances[cId];
                }
            }
            _instances[componentId] = new ComponentEditor();
         ...
         *
         * @description
         * Method called to discard an instance of `ComponentEditor` associated to a given `componentId`.
         * 
         * @param {String} componentId The identifier of the component to which is associated the `ComponentEditor` that should be destroyed.
         */
        this.destroyInstance = function(componentId) {
    ...
    .controller('componentEditorController', function($q, $scope, componentEditorService) {
        var componentEditor = componentEditorService.getInstance(this.componentId);
        ...
        // override default onSubmit of generic editor to have a single save once lall tab data is colleced
        this.onSubmit = function() {
            var payload = this.sanitizePayload(this.component, this.fields);
        ...
        this.$onDestroy = function() {
            ...
            componentEditorService.destroyInstance(this.componentId);
        }.bind(this);
    })
 ...
 * @param {String} componentId The identifier of the component being created/modified.
...
.component('componentEditor', {
    transclude: false,
    templateUrl: 'web/features/cmssmarteditContainer/components/cmsComponents/editorModal/componentEditor/tabInnerTemplate.html',

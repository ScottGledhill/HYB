...
(function() {
    angular.module("navigationEditorModule", [
        ...
        .controller("navigationEditorController", function($q, $translate, lodash, URIBuilder, NAVIGATION_MANAGEMENT_RESOURCE_URI, NAVIGATION_NODE_ROOT_NODE_UID, catalogService, TreeService, navigationEditorNodeService, navigationNodeEditorModalService, navigationEntryItemService, confirmationModalService, navigationNodeRestService, systemEventService, CONTEXT_SITE_ID, CONTEXT_CATALOG_VERSION, NODE_CREATION_EVENT) {
            ...
            if (!this.readOnly) {
                this.dragOptions = {
                    ...
                    beforeDropCallback: function(event) {
                        if (event.sourceNode.parent.uid !== event.destinationNodes[0].parent.uid) {
                            return {
                                confirmDropI18nKey: 'navigationmanagement.navnode.confirmation'
                            };
                        } else {
                            return true;
                        }
            ...
            this.nodeTemplateUrl = 'web/features/cmssmarteditContainer/components/navigation/navigationEditor/navigationNodeRenderTemplate.html';
            this.catalogName = "";
            ...
            catalogService.getCatalogByVersion(this.uriContext[CONTEXT_SITE_ID], this.uriContext[CONTEXT_CATALOG_VERSION]).then(function(catalogs) {
            ...
            var dropdownItems = [{
                ...
                key: 'navigationmanagement.navnode.addchild',
                condition: function(handle) {
                ...
                key: 'navigationmanagement.navnode.addsibling',
                condition: function(handle) {
                    return !handle.$modelValue.itemId;
                },
                callback: function(handle) {
            ...
            this.actions = {
                ...
                isReadOnly: function(treeService) {
                ...
                removeItem: function(treeService, handle) {
                    ...
                    var nodeData = handle.$modelValue;
                    var message = {};
                    message.description = nodeData.itemId ? "navigationmanagement.navnode.removeentry.confimation.message" : "navigationmanagement.navnode.removenode.confimation.message";
                    message.title = nodeData.itemId ? "navigationmanagement.navnode.removeentry.confimation.title" : "navigationmanagement.navnode.removenode.confimation.title";
                    ...
                    confirmationModalService.confirm(message).then(function() {
                        if (!nodeData.itemId) {
                            ...
                            navigationNodeRestService.update(payload).then(function(response) {
                ...
                addTopLevelNode: function(treeService) {
        ...
        .directive('navigationEditor', function() {
            ...
            return {
                ...
                transclude: false,
                replace: false,
                templateUrl: 'web/features/cmssmarteditContainer/components/navigation/navigationEditor/navigationEditorTemplate.html',

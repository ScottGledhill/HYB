...
angular.module('productSelectorModule', ['catalogAwareSelectorModule', 'catalogInformationServiceModule'])
     ...
     */
    .constant('PRODUCT_TEMPLATE_FOR_SELECTOR', 'web/features/cmssmarteditContainer/components/genericEditor/catalog/components/productSelector/productTemplate.html')
    /**
     * @ngdoc object
     * @name productSelectorModule.object:PRODUCT_TEMPLATE_FOR_SELECTOR
     * @description
    ...
    .component('seProductSelector', {
        templateUrl: 'web/features/cmssmarteditContainer/components/genericEditor/catalog/components/productSelector/productSelectorTemplate.html',

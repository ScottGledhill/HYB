 ...
 */
.controller('slotVisibilityButtonController', function(slotVisibilityService, $scope) {
    ...
    .directive('slotVisibilityButton', function() {
        return {
            templateUrl: 'web/features/cmssmartedit/components/slotVisibility/slotVisibilityButtonTemplate.html',
            restrict: 'E',
            transclude: true,
            replace: false,

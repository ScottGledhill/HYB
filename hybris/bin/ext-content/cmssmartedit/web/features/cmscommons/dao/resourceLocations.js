...
(function() {
     ...
     */
    .constant('CONTEXTUAL_PAGES_RESTRICTIONS_RESOURCE_URI', '/cmswebservices/v1/sites/' + CONTEXT_SITE_ID + '/catalogs/' + CONTEXT_CATALOG + '/versions/' + CONTEXT_CATALOG_VERSION + '/pagesrestrictions')
     ...
     */
    .constant('GET_PAGE_SYNCHRONIZATION_RESOURCE_URI', '/cmssmarteditwebservices/v1/sites/' + CONTEXT_SITE_ID + '/catalogs/' + CONTEXT_CATALOG + '/versions/' + CONTEXT_CATALOG_VERSION + '/synchronizations/versions/:target/pages/:pageUid')

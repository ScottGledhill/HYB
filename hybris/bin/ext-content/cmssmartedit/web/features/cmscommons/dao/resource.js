...
(function() {
    ...
    angular.module('resourceModule', ['restServiceFactoryModule', 'resourceLocationsModule', 'functionsModule'])
         ...
         */
        .factory('itemsResource', function(restServiceFactory, ITEMS_RESOURCE_URI, CONTEXT_CATALOG, CONTEXT_CATALOG_VERSION, CONTEXT_SITE_ID) {
            ...
            return {
                 ...
                 * 
                 * @param {Object} context A list containing the current uri context.
                 * @param {String} context.CONTEXT_SITE_ID contains the site uid.
                 * @param {String} context.CONTEXT_CATALOG contains the catalog uid.
                 * @param {String} context.CONTEXT_CATALOG_VERSION contains the catalog version.
                 */
                getItemResourceByContext: function(context) {
                    return restServiceFactory.get(ITEMS_RESOURCE_URI.replace(CONTEXT_SITE_ID, context.CURRENT_CONTEXT_SITE_ID).replace(CONTEXT_CATALOG, context.CURRENT_CONTEXT_CATALOG).replace(CONTEXT_CATALOG_VERSION, context.CURRENT_CONTEXT_CATALOG_VERSION));
                }

...
describe('slotVisibilityService', function() {
    ...
    var restServiceFactory, slotVisibilityService, itemsResource, pagesContentSlotsComponentsResource;
    var renderService;
    var $q, $rootScope;
    ...
    beforeEach(module('restServiceFactoryModule', function($provide) {
        ...
        itemsResource = jasmine.createSpyObj('itemsResource', ['get', 'getItemResource']);
        ...
        itemsResource.getItemResource.andCallFake(function() {
            return restServiceFactory.get('ITEMS');
        });

        $provide.value('restServiceFactory', restServiceFactory);
        $provide.value('itemsResource', itemsResource);
    ...
    describe('content slots per page is empty', function() {
        ...
        beforeEach(function() {
            itemsResource.get.andReturn($q.when([]));

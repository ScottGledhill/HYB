 ...
 */
angular.module('LanguageMocks', ['ngMockE2E', 'resourceLocationsModule', 'functionsModule'])
...
try {
    angular.module('smarteditloader').requires.push('LanguageMocks');
    angular.module('smarteditcontainer').requires.push('LanguageMocks');
} catch (ex) {}

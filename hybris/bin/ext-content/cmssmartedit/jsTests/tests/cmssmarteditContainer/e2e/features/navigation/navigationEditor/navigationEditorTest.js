...
describe('navigation Editor - ', function() {
    ...
    beforeEach(function() {
        ...
        browser.get('jsTests/tests/cmssmarteditContainer/e2e/features/navigation/navigationEditor/navigationEditorTest.html');
        browser.waitForContainerToBeReady();
        navigationTree.navigateToFirstCatalogNavigationEditor();
    ...
    it('GIVEN I am on the navigation editor of the first catalog WHEN I select "Delete" from the more menu of node4 THEN it should be deleted when the user presses "Ok" in the confirmation modal', function() {
        ...
        expect(navigationTree.getDeleteConfirmationMessage()).toBe('Deleting a Node will delete all nodes and entries associated to it. Do you want to continue ?');

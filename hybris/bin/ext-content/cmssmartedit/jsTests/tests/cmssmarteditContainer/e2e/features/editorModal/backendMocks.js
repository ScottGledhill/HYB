...
angular.module('backendMocks', ['ngMockE2E', 'functionsModule', 'resourceLocationsModule'])
    .run(function($httpBackend, filterFilter, parseQuery, I18N_RESOURCE_URI, LANGUAGE_RESOURCE_URI, TYPES_RESOURCE_URI, STRUCTURES_RESOURCE_URI, ITEMS_RESOURCE_URI) {
        ...
        $httpBackend.whenGET(new RegExp(STRUCTURES_RESOURCE_URI + "/.*")).respond(function(method, url, data, headers) {
            var allStructures = {
                structures: [{
                    attributes: [{
                        cmsStructureType: "ShortString",

...
describe('pageTypesRestrictionTypesService', function() {
    ...
    beforeEach(module('pageTypesRestrictionTypesServiceModule', function($provide) {
        ...
        pageTypesRestrictionTypesRestService.getRestrictionTypeCodesForPageType.andCallFake(function() {
            return $q.when(pageTypesRestrictionTypesMocks.getTypeCodesForContentPageMocks());
        });
        pageTypesRestrictionTypesRestService.getPageTypesRestrictionTypes.andCallFake(function() {
    ...
    it('should cache the results and return cache if it exists', function() {
        ...
        expect(pageTypesRestrictionTypesRestService.getPageTypesRestrictionTypes.calls.length).toBe(1);

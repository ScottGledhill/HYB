    ...
    describe('saveTabData create mode - ', function() {
        ...
        it('GIVEN only one tab is modified' +
            ...
            function() {
                ...
                //GIVEN
                mockComponentService.createNewComponent.andReturn($q.when(payload_tab1));
        ...
        it('GIVEN when two tab are modified' +
            ...
            function() {
                ...
                //GIVEN
                mockComponentService.createNewComponent.andReturn($q.when($.extend({}, payload_tab1, payload_tab2)));
                ...
                //THEN
                expect(mockComponentService.createNewComponent.calls.length).toBe(1);
        ...
        it('GIVEN when all three are modified' +
            ...
            function() {
                ...
                //GIVEN
                mockComponentService.createNewComponent.andReturn($q.reject(error_response));
                ...
                //THEN
                expect(mockComponentService.createNewComponent).toHaveBeenCalledWith(componentInfo, $.extend({}, payload_tab1, payload_tab2, payload_tab3));
    ...
    describe('saveTabData update mode - ', function() {
        ...
        it('GIVEN in edit mode ' +
            ...
            function() {
                ...
                //GIVEN 
                mockComponentService.loadComponentItem.andReturn($q.when($.extend({}, payload_tab1, payload_tab2, payload_tab3)));

                //WHEN
                var promise = componentEditor.fetchTabsContent('componentId');

                //THEN
                expect(promise).toBeResolvedWithData($.extend({}, payload_tab1, payload_tab2, payload_tab3));
            });
        ...
        it('GIVEN when all three tabs are modified ' +
            ...
            function() {
                ...
                var finalResponse = $.extend({}, payload_tab1, payload_tab2, payload_tab3);
                var additionalFields = {
                    identifier: 'componentId',
                    additionalField1: 'additionalField1',
                    additionalField2: 'additionalField2'
                };
                var totalPayload = $.extend({}, payload_tab1, payload_tab2, payload_tab3, additionalFields);

                //GIVEN 
                mockComponentService.updateComponent.andReturn($q.when(finalResponse));
                ...
                var promise1 = componentEditor.saveTabData($.extend({}, payload_tab1, additionalFields), tab1, tab1_fields); //save tab1
                var promise2 = componentEditor.saveTabData($.extend({}, payload_tab2, additionalFields), tab2, tab2_fields); //save tab2
                var promise3 = componentEditor.saveTabData($.extend({}, payload_tab3, additionalFields), tab3, tab3_fields); //save tab3

                //THEN
                expect(mockComponentService.updateComponent.calls.length).toBe(1);
                ...
                expect(promise3).toBeResolvedWithData({
                    payload: $.extend({}, payload_tab3, additionalFields),
                    response: finalResponse
                });
            });

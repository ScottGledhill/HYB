...
describe('addPageWizardController', function() {
    ...
    beforeEach(function() {
        ...
        var harness = AngularUnitTestHelper.prepareModule('addPageServiceModule')
            ...
            .mock('languageService', 'getResolveLocale').andReturnResolvedPromise("TE_LANGUAGE")
            .mock('pageTemplateService', 'getPageTemplatesForType')
            .mock('createPageService', 'createPage').andReturnResolvedPromise('page created')
            .mock('addPageWizardService', 'getPageTypeFields').andReturnResolvedPromise(true)
            .mock('experienceService', 'updateExperiencePageId')
            .mock('pageTypeService', 'getPageTypes').andReturnResolvedPromise(MOCK_PAGE_TYPES)
            .mock('pageService', 'getPrimaryPagesForPageType').andReturnResolvedPromise([])
            .mock('restrictionsStepHandlerFactory', 'createRestrictionsStepHandler').andReturn(restrictionsStepHandler)
            .mock('wizardManager')

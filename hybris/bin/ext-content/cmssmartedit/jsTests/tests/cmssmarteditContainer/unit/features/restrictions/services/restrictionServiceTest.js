...
describe('restrictionService', function() {
    ...
    var restrictionsService, restrictionsRestService;
    ...
    var MOCK_STRUCTURE_URI = "/cmssmarteditwebservices/v1/structures/:smarteditComponentType?mode=EDIT";
    ...
    beforeEach(module('restrictionsServiceModule', function($provide) {
        ...
        restrictionsRestService.getContentApiUri.andCallFake(function() {
            return $q.when(MOCK_URI_CONTEXT);
        });
        restrictionsRestService.getById.andCallFake(function() {
        ...
        structuresRestService.getUriForContext.andCallFake(function() {
        ...
        structureModeManagerFactory.createModeManager.andCallFake(function() {
    ...
    it('should return all restrictions', function() {
        restrictionsRestService.get.andReturn($q.when(MOCK_RESTRICTIONS));
    ...
    it('should get restrictions based on page and type', function() {
        restrictionsRestService.get.andReturn($q.when(MOCK_RESTRICTION));

...
public class CategorySearchController
{
	...
	@ResponseBody
	public CategorySearchResultWsDTO findProductCategoriesByText(@RequestParam(required = false) final String text,
			@ModelAttribute final PageableWsDTO pageableDto)
	{
		final SearchResult<CategoryData> productSearchResult = getCmsSeProductSearchFacade().findProductCategories(text, Optional.of(pageableDto)

	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20161207112050_commercesearch_artifact_develop_4673ded/prepare/build/source/commercesearchatddtests/genresources/robottests/GeneralSearch_Tests.txt"));
		}

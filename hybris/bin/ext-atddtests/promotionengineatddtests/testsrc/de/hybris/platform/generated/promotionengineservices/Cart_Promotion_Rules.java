	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20161207151852_promotionengine_artifact_develop_6e93fd8/prepare/build/source/promotionengineatddtests/genresources/robottests/Cart_Promotion_Rules.txt"));
		}

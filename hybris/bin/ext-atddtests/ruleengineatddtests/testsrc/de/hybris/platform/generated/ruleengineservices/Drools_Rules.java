	...
	public static void startSuite() throws IOException
	{
		if (robotTestSuite == null)
		{
			...
			robotTestSuite = robotTestSuiteFactory.parseTestSuite(robotSettings, new File(
					"/rp/tmp/pipelines/20170110092224_ruleengine_artifact_release_6.3.0_ff0628c/prepare/build/source/ruleengineatddtests/genresources/robottests/Drools_Rules.txt"));
		}
